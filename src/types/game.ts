...
export interface AvatarCustomization {
  gender:       "male" | "female";
  outline:      "round" | "square" | "slim";   // 顔のりんかく
  eyes:         "normal" | "big" | "sharp" | "sleepy";
  nose:         "normal" | "small" | "button";
  mouth:        "wide" | "normal" | "small";
  frontHair:    "bangs" | "side" | "center" | "none";  // 前髪
  backHair:     "short" | "medium" | "long" | "bob";   // 後髪
...
export interface Player {
  ...
  turnCount:     number;
  customization?: AvatarCustomization;  // ゲーム開始時に作成したアバター
}
